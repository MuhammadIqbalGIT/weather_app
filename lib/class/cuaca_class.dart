class CuacaModel {
  ...
  CuacaModel({this.cod, this.message, this.cnt, this.list, this.city});
...
class Main {
  ...
  Main.fromJson(Map<String, dynamic> json) {
    ...
    feelsLike = (json['feels_like'] != null) ? json['feels_like'].toDouble() : null;
...
class Rain {
  ...
  Rain.fromJson(Map<String, dynamic> json) {
    d3h = (json['3h'] != null) ? json['3h'].toDouble() : null;
  }
